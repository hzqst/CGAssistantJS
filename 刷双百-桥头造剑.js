var cga = require('./cgaapi')(function(){
	console.log('开始执行模块：刷双百-杖，需要轻木+铜脚本，集合地点 桥头');
	...
	var copper_movepos = [152, 117];
	var wood_movepos = [152, 122];
	...
	var docraft = ()=>{
		...
		if(cga.getItemCount('铜条') < 4){
			wait_copper();
			return;
		}
		
		var craftItemName = '长剑';
		...
		if(items.length > 20 - trade_count){
			trade_movefunc(()=>{
				...
				[151, 122]
					...
					cga.TurnTo(149, 122);
					var sellarray = cga.findItemArray('长剑');
