var cga = require('../cgaapi')(function(){
	...
	cga.SayWords('欢迎使用红叶の四转脚本换花', 0, 3, 1);
	
	if(is_array_contain(red,myname)){
		cga.SayWords('我是红组', 0, 3, 1);
		mineObject = mineArray[0];
	}else if(is_array_contain(blue,myname)){
		cga.SayWords('我是蓝组', 0, 3, 1);
		mineObject = mineArray[1];
	}else if(is_array_contain(yellow,myname)){
		cga.SayWords('我是黄组', 0, 3, 1);
		mineObject = mineArray[2];
