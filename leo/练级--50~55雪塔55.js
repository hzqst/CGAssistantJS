require('./common').then(cga => {
    ...
    leo.log('红叶の雪塔55脚本，位置点【' + meetingPoint + '】，推荐50~55级使用，启动~');
        ...
        return leo.loop(
            ...
            .then(() => {
                ...
                if (isTeamLeader) {
                    ...
                    if (mapInfo.name.indexOf('雪拉威森塔５５层')!=-1){
                        return leo.encounterTeammate(protect, '雪拉威森塔５５层'); //队员遇敌
                    }
                }
                //console.log('延时3秒');
